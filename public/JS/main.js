...
for (let index = 0; index < 3; index++) {
    ...
    switch (index) {
        case 0:
            boutonModif[0].innerHTML = "A faire";
            break;
        case 1:
            boutonModif[1].innerHTML = "terminer";
            break;
        case 2:
            boutonModif[2].innerHTML = "Tout";
            break;
    }
};
